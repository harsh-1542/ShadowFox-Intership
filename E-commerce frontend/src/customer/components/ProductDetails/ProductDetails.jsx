        ...
        <div className="bg-white lg:px-20">
            <div className="pt-6">
                ...
                <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
                    ...
                    <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
                        <div className="lg:col-span-2 ">
                            <h1 className="text-lg lg:text-xl font-semibold text-gray-900">POLO t-shirt</h1>
                            <h1 className='text-lg lg:text-xl text-gray-900 opacity-60 pt-1'>Black t-shirt</h1>
                        </div>
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <form className="mt-10">
                                ...
                                <Button onClick={handleAddToCart} variant="contained" sx={{px:"2rem", py:"1rem",bgcolor:"#8155fd"}}>
                                    Add to Cart
                                </Button>
                            </form>
                        </div>
                        ...
                        <Grid container  spacing={7}>
                            ...
                            <Grid item xs={5} >
                                ...
                                <div className='flex'>
                                    ...
                                    <p className='opacity-60'>3456354 Ratings</p>
                                </div>
                ...
                <section className='pt-10'>
                    <h1 className='py-5 text-lg'>Similar Products</h1>
